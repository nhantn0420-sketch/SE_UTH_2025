...
![Figure 3.2.2: Create Project Flow with AI Milestone Generation](../Images/CreateProjectFlowwithAIMilestoneGeneration.png)

*Figure 3.2.2: Sequence diagram showing the project creation flow with optional AI-powered milestone generation using AWS Bedrock (Claude).*
...
![Figure 3.2.3: Project Approval Workflow](../Images/ApproveProjectFlow.png)

*Figure 3.2.3: Sequence diagram illustrating the project submission, review, and approval/denial workflow by Head of Department.*
...
![Figure 3.2.4: Student Picks Project for Team](../Images/StudentPicksProjectforTeam.png)

*Figure 3.2.4: Sequence diagram showing how students (team leaders) select and assign approved projects to their teams.*
...
![Figure 3.2.5: Create Team and Add Members Flow](../Images/CreateTeamandAddMembersFlow.png)

*Figure 3.2.5: Sequence diagram depicting the process of team creation and member management with role assignment.*
...
![Figure 3.2.6: Submit Checkpoint with Files](../Images/SubmitCheckpointwithFile.png)

*Figure 3.2.6: Sequence diagram showing student checkpoint submission process including file uploads to Cloudinary CDN.*

![Figure 3.2.7: Evaluate Checkpoint Submission](../Images/EvaluateCheckpointSubmission.png)

*Figure 3.2.7: Sequence diagram illustrating lecturer's checkpoint evaluation process with grade and feedback.*
...
![Figure 3.2.8: Real-time Chat with WebSocket](../Images/Real-time ChatwithWebSocket.png)

*Figure 3.2.8: Sequence diagram illustrating the real-time chat communication flow using WebSocket (Socket.IO) protocol.*
...
![Figure 3.2.9: Video Call with WebRTC](../Images/VideoCallwithWebRTC.png)

*Figure 3.2.9: Sequence diagram showing WebRTC-based peer-to-peer video call establishment and communication flow.*
...
![Figure 3.2.10: Peer Review Process](../../04-SDD/diagrams/4.3.14-seq-peer-review.png)

*Figure 3.2.10: Sequence diagram showing the peer review process with 4-dimensional scoring system and anonymous feedback.*
