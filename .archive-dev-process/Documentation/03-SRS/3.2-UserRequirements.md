...
![Figure 3.2.2: Create Project Flow with AI Milestone Generation](../../04-SDD/diagrams/4.3.8-seq-create-project.png)
...
![Figure 3.2.3: Project Approval Workflow](../../04-SDD/diagrams/4.3.9-seq-approve-project.png)
...
![Figure 3.2.4: Student Picks Project for Team](../../04-SDD/diagrams/4.3.11-seq-pick-project.png)
...
![Figure 3.2.5: Create Team and Add Members Flow](../../04-SDD/diagrams/4.3.10-seq-create-team.png)
...
![Figure 3.2.6: Submit Checkpoint with Files](../../04-SDD/diagrams/4.3.12-seq-submit-checkpoint.png)

*Figure 3.2.6: Sequence diagram showing student checkpoint submission process including file uploads to Cloudinary CDN.*

![Figure 3.2.7: Evaluate Checkpoint Submission](../../04-SDD/diagrams/4.3.13-seq-evaluate-checkpoint.png)
...
![Figure 3.2.8: Real-time Chat with WebSocket](../../04-SDD/diagrams/4.3.15-seq-chat-message.png)
...
![Figure 3.2.9: Video Call with WebRTC](../../04-SDD/diagrams/4.3.16-seq-video-call.png)
